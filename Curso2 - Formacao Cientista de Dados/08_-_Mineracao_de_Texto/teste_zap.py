...
corpus = PlaintextCorpusReader('Arquivos2', 'zap3.txt')
...
apendice_stop = ['Carlos', 'Anderson', 'Mutuka', 'Danilo', 'Leite',
                 'Thyago', 'Éder', 'Pelé', 'Rafael', 'Maydana', 'aí', 'vc',
                 'AM', 'PM', 'Donaldo', 'Luiz', 'Renato', 'pra', 'pq', 'ai', 'ta',
                 'aqui', 'kkkk', 'kkkkk', 'kkkkkk', 'la', 'lá', 'eh', 'tá', 'to', 'Jti']
stops = stopwords.words('portuguese')
stops = stops + apendice_stop
