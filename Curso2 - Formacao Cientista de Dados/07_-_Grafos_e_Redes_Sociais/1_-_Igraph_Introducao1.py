...
print(grafo1)
plot(grafo1, bbox = (250, 250))

# O igraph original traz um bug para windows que não te permite ver as labels.
# Sendo assim, é necessário mudar manualmente seguindo os links abaixo:
# https://github.com/igraph/python-igraph/issues/185
