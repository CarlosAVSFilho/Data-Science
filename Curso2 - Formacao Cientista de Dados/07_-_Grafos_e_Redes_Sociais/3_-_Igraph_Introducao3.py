...
print(grafo4.get_adjacency()) #matriz de adjacência
...
for v in grafo5.vs: #Informações sobre os vértices
    print(v)
grafo5.vs[0]
...
for e in grafo5.es: #Informações sobre as arestas
    print(e)
grafo5.es[0]
